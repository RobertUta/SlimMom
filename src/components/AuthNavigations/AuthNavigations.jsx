...
const AuthNavigations = ({ dailyRate, userDataDailyRate }) => (
  <div className={styles.authnav}>
    <NavLink exact to="/diary" className={styles.link} activeClassName={styles.active}>
     DIARY
    </NavLink>
    <NavLink exact to="/calculator" className={styles.link} activeClassName={styles.active}>
      CALCULATOR
    </NavLink>
  </div>
);
